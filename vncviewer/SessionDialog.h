...
public:
	...
	// ini文件读取
	void ReadINIProcEncoders();//读取Encoders模块
	void ReadINIProcKeyboardMouse();//读取keyboardMouse模块
	void ReadINIProcDisplay();//读取Display模块
	void ReadINIProcMisc();//读取Misc模块
	void ReadINIProcSecurity();//读取Security模块
	void ReadINIProc();//读取链接画面
	void ReadINIProcListen();//读取Listen模块
